 ...
 for k=1:length(velocidadades)
         ...
         fileName= sprintf('N=100_Repeticiones=10/FLOW_N=100_DrivingVelocity=%d.00000.csv',velocidad);
  ...
  title('N=100. Repeticiones=10. Paso velocidades=1','fontsize', 20);
  axis([0.9 8.2]);
  print -dpng 'N=100_Repeticiones=10/graficoD.png'
