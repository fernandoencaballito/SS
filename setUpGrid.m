...
%! assert(any (matrix{2,1}==2 ) );
%! assert(any (matrix{2,2}==3 ) );
%! assert(any (matrix{1,1}==1 ) );
%! assert(any (matrix{1,1}==4 ) );
%! assert(any (matrix{1,1}==5 ) );
%! assert(length (matrix{2,1})==1);
%! assert(length (matrix{1,2})==0);
%! assert(length (matrix{1,1})==3);
%! assert(length (matrix{2,2})==1);
